...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2025 a las 16:28:57
...
-- Procedimientos
--
CREATE  PROCEDURE `ActualizarEstadoPagoPorCedula` (IN `cedulaProfesor` VARCHAR(20))   BEGIN
...
CREATE  PROCEDURE `DetallesPagoCurso` (IN `p_IdCurso` INT)   BEGIN
    SELECT 
        m.Id ,
        c.NombreCurso,
        m.Nombre  ,
...
CREATE  PROCEDURE `EliminarProfesor` (IN `profesorID` INT)   BEGIN
...
CREATE  PROCEDURE `InsertarMovimientoPagoProfesor` (IN `p_tipoMovimiento` TINYINT, IN `p_monto` DECIMAL(10,2), IN `p_idCurso` INT, IN `p_idProfesor` INT, IN `p_Notas` TEXT, IN `p_comprobante` VARCHAR(100), IN `p_fecha` DATETIME, IN `p_calculoPago` INT)   BEGIN
...
CREATE  PROCEDURE `InsertarMovimientoPorMatriculaPagoCliente` (IN `p_IdMatricula` INT, IN `p_Cuota` DECIMAL(10,2), IN `p_Notas` VARCHAR(255), IN `p_Comprobante` VARCHAR(255))   BEGIN
...
CREATE  PROCEDURE `InsertarMovimientoPorMatriculaPagoProfesor` (IN `p_IdCurso` INT, IN `p_Notas` VARCHAR(255), IN `p_Comprobante` VARCHAR(255))   BEGIN
...
CREATE  PROCEDURE `InsertarPagosProfesores` ()   BEGIN
...
CREATE  PROCEDURE `ObtenerHorariosCurso` (IN `cursoID` INT)   BEGIN
    SELECT 
        h.ID AS `idHorario`,
        h.DiaSemana AS `Dia`,
...
CREATE  PROCEDURE `SP_BORRAR_REGISTROS_MATRICULA` (IN `p_idMatricula` INT)   BEGIN
...
CREATE  PROCEDURE `SP_CREAR_USUARIO` (IN `p_email` VARCHAR(255), IN `p_password` VARCHAR(255), IN `p_fullName` VARCHAR(255), IN `p_activo` INT, IN `p_rolAdmin` INT, IN `p_rolServicio` INT, IN `p_rolContable` INT, IN `p_rolReporteria` INT)   BEGIN
    DECLARE userID INT;
...
CREATE  PROCEDURE `SP_EDITAR_USUARIO_V2` (IN `p_usuarioID` INT, IN `p_email` VARCHAR(255), IN `p_password` VARCHAR(255), IN `p_fullName` VARCHAR(255), IN `p_rolAdmin` INT, IN `p_rolServicio` INT, IN `p_rolContable` INT, IN `p_rolReporteria` INT, IN `p_activo` BIT)   BEGIN
...
CREATE  PROCEDURE `SP_ELIMINAR_MATRICULA` (IN `idMatricula` INT)   BEGIN
...
CREATE  PROCEDURE `SP_INSERTAR_MATRICULAS_ADMIN` (IN `p_Nombre` VARCHAR(100), IN `p_Cedula` VARCHAR(50), IN `p_Telefono` VARCHAR(20), IN `p_Correo` VARCHAR(100), IN `p_EstadoPago` VARCHAR(50), IN `p_IdCurso` INT, IN `p_IdHorario` INT)   BEGIN
...
CREATE  PROCEDURE `SP_INSERTAR_MATRICULAS_USUARIO` (IN `p_Nombre` VARCHAR(100), IN `p_Cedula` VARCHAR(50), IN `p_Telefono` VARCHAR(20), IN `p_Correo` VARCHAR(100), IN `p_EstadoPago` VARCHAR(50), IN `p_Comprobante` VARCHAR(255), IN `p_IdCurso` INT, IN `p_IdHorario` INT)   BEGIN
    DECLARE v_cantidadCuotas INT;
    DECLARE v_fechaInicio DATE;
    DECLARE v_cuotasPendientes INT;
    DECLARE v_diasRestantes INT;
...
CREATE  PROCEDURE `SP_RevertirPago` (IN `p_id_movimiento` INT, IN `p_id_matricula` INT)   BEGIN
...
CREATE  PROCEDURE `ValidarCuotasPagadasEnvioMensaje` (IN `idMatricula` INT)   BEGIN
...
CREATE  PROCEDURE `ValidarYInsertarHorario` (IN `p_DiaSemana` VARCHAR(20), IN `p_HoraInicio` TIME, IN `p_HoraFin` TIME, IN `p_IdCurso` INT, IN `p_IdProfesor` INT, IN `p_Cupo` INT, OUT `p_Resultado` INT, OUT `p_Mensaje` VARCHAR(255))   BEGIN
...
(263, 'fwd', 'fweqfwef', '506', 'wefwefw'),
(264, 'efwef', 'wefwefwe', '50612312312', 'joser2320@gmail.com'),
(265, 'efwef', '23423423423', '50612312312', 'joser2320@gmail.com'),
(266, 'qwqwd', '23123123', '50612312312', '123123123123'),
(267, 'qwqwd', '23123123qwdqwd', '50612312312', '123123123123'),
(268, '12321312', '111123333334444', '50621312312', '123123123123'),
(269, 'e123e12', '3123123345344578', '506123123', '3123123123'),
(270, '3rfgertg3r', 'g23423686789689', '506895245', 'ujtyhrfgtgrtgrthrthrth'),
(271, '45345fger', '345345345345grger', '506345345', 'egergerg'),
(272, 'afqewdf', 'qweq132123123', '50612312312', '123123123'),
(273, 'qwdqwd', 'w123413454654567980', '5063234234', '23423423423'),
(274, 'qwedfq2wdqw4232efasdfw', 'd34234234efwefwef', '50623423423', '23423423423'),
(275, 'qwdqwd', 'qwd1231231', '5062312', 'fwefwef'),
(276, 'wqwdqwqwdqwdwqdqwd', '12331212312312312345', '50612312312', 'fwefwefwef'),
(277, 'qwqqwqw', 'qwwqqw1212122', '5061233123', '13123'),
(278, 'wqddqwqwdwdqwdq', '123123132123', '50623112312', 'qaewd23e123e123'),
(279, 'efwsdfwefwef', '34wfret345356456y45', '50623423412', '2353werf3wer32ef'),
(280, 'qwdwqdqwd', 'qwqwdqwd', '506', 'qweq3123123123'),
(281, '3wdzdeedwszedwz', '2323445457ujnmthjthr', '5063453453', '453t3rg3rg'),
(282, 'sdqw', 'd123123333', '50612312312', 'f3rf3rf343'),
(283, '12341231', '2312312312312adfwfw', '50612312312', '12dfwefwefwef'),
(284, '54356435', '6345345', '50634534534', '45345345345'),
(285, '33wedq3ew2', '123123123asdawd', '50612312', '12312312');
...
(79, 'CURSO DE PRUEBNA', 'CURSO DE PRUEBNA', '2025-04-13', '2025-05-31', b'1', 123123.00, 12, 3, 1);
...
(58, 'Patricia Ramírez Rimolo ', '108270565 ', '50670395794', 'masiescara98@gmail.com', 'Pendiente', '2025031010283006162174131', NULL),
(59, 'Katherine Siles Madrigal', '110590914', '50683119972', 'kathysilesm20@gmail.com', 'Pendiente', '92875642', NULL),
(60, 'Karen García Quirós ', '118720579', '50672416747', 'karengarciaquiross@gmail.com', 'Pendiente', '15901511', NULL);
...
(43, 'Viernes', '19:00:00', '20:30:00', 38, 1, 60),
...
(83, 'Lunes', '11:09:00', '13:00:00', 79, 5, 60);
...
(28, 'Milena Mendoza Valenciano', '701100837', '50689932919', 'mmendoza@una.ac.cr', 'Pendiente', '94210067', 44, 49, NULL, 0, 3, 1, 1, '2025-03-23 16:57:08'),
...
(37, 'Valentina gabriela Morales Sánchez ', '402730546', '50684490254', 'valentinagabriela1406@gmail.com', 'Pendiente', '30860478', 40, 45, NULL, 0, 3, 1, 1, '2025-03-23 16:57:08'),
...
(56, 'Marian Carillo Valverde ', '111560465', '50670155093', 'valerysala07@gmail.com', 'Pendiente', '32933781', 43, 48, NULL, 0, 3, 1, 1, '2025-03-23 16:57:08'),
...
(305, 'fwd', 'fweqfwef', '506', 'wefwefw', 'Pendiente', '', 31, 35, NULL, 0, 3, 1, 1, '2025-05-11 06:40:32'),
(306, 'efwef', 'wefwefwe', '50612312312', 'joser2320@gmail.com', 'Pendiente', '3423423423', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:21:39'),
(307, 'efwef', '23423423423', '50612312312', 'joser2320@gmail.com', 'Pendiente', '3423423423', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:22:00'),
(308, 'qwqwd', '23123123', '50612312312', '123123123123', 'Pendiente', '12312312312', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:27:02'),
(309, 'qwqwd', '23123123qwdqwd', '50612312312', '123123123123', 'Pendiente', '12312312312', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:28:06'),
(310, '12321312', '111123333334444', '50621312312', '123123123123', 'Pendiente', '123123', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:31:21'),
(311, 'e123e12', '3123123345344578', '506123123', '3123123123', 'Pendiente', '', 79, 83, NULL, 0, 2, 1, 1, '2025-05-11 07:31:43'),
(312, '3rfgertg3r', 'g23423686789689', '506895245', 'ujtyhrfgtgrtgrthrthrth', 'Pendiente', '', 79, 83, NULL, 0, 2, 1, 1, '2025-05-11 07:32:32'),
(313, '45345fger', '345345345345grger', '506345345', 'egergerg', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:37:52'),
(314, 'afqewdf', 'qweq132123123', '50612312312', '123123123', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:39:10'),
(315, 'qwdqwd', 'w123413454654567980', '5063234234', '23423423423', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:40:56'),
(316, 'qwedfq2wdqw4232efasdfw', 'd34234234efwefwef', '50623423423', '23423423423', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:44:31'),
(317, 'qwdqwd', 'qwd1231231', '5062312', 'fwefwef', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:45:02'),
(318, 'wqwdqwqwdqwdwqdqwd', '123312123123123123453645456', '50612312312', 'fwefwefwef', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:48:45'),
(319, 'qwqqwqw', 'qwwqqw1212122', '5061233123', '13123', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:52:30'),
(320, 'wqddqwqwdwdqwdq', '123123132123', '50623112312', 'qaewd23e123e123', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:54:41'),
(321, 'efwsdfwefwef', '34wfret345356456y45', '50623423412', '2353werf3wer32ef', 'Pendiente', '', 79, 83, NULL, 0, 3, 1, 1, '2025-05-11 07:59:43'),
(322, 'qwdwqdqwd', 'qwqwdqwd', '506', 'qweq3123123123', 'Pendiente', '', 25, 28, NULL, 0, 2, 1, 1, '2025-05-11 08:05:24'),
(325, '12341231', '2312312312312adfwfw', '50612312312', '12dfwefwefwef', 'Pendiente', 'r3eewrszXW#R', 79, 83, NULL, 0, 0, 1, 1, '2025-05-11 08:18:20'),
(326, '54356435', '6345345', '50634534534', '45345345345', 'Pendiente', '534534534545', 79, 83, NULL, 0, 0, 1, 1, '2025-05-11 08:21:00'),
(327, '33wedq3ew2', '123123123asdawd', '50612312', '12312312', 'Pendiente', '0', 79, 83, NULL, 0, 2, 1, 1, '2025-05-11 08:24:50');
...
(575, 1, '06c4659a094deafbff6bf8d1d3c32236', '2025-05-11 05:55:40', '2025-05-11 14:55:40');
...
(71, 'Sistema', '50621312312', 'Hola 12321312. Hemos recibido su solicitud de matrícula, pronto le informaremos por este medio cuand', '2025-05-11 07:31:22'),
(72, 'Sistema', '50612312312', 'Hola 12341231. Hemos recibido su solicitud de matrícula, pronto le informaremos por este medio cuand', '2025-05-11 08:18:21'),
(73, 'Sistema', '50634534534', 'Hola 54356435. Hemos recibido su solicitud de matrícula, pronto le informaremos por este medio cuand', '2025-05-11 08:21:01'),
(74, 'Sistema', '50612312', 'Hola 33wedq3ew2. Hemos recibido su solicitud de matrícula, pronto le informaremos por este medio cua', '2025-05-11 08:24:51');
...
--
ALTER TABLE `bitacoria_clientes`
  MODIFY `CONSECUTIVO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=286;
...
--
ALTER TABLE `sesiones`
  MODIFY `IDSesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=576;
