...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2025 a las 05:01:54
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_BORRAR_REGISTROS_MATRICULA` (IN `p_idMatricula` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_ELIMINAR_MATRICULA` (IN `idMatricula` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_INSERTAR_MATRICULAS_ADMIN` (IN `p_Nombre` VARCHAR(100), IN `p_Cedula` VARCHAR(50), IN `p_Telefono` VARCHAR(20), IN `p_Correo` VARCHAR(100), IN `p_EstadoPago` VARCHAR(50), IN `p_IdCurso` INT, IN `p_IdHorario` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_INSERTAR_MATRICULAS_USUARIO` (IN `p_Nombre` VARCHAR(100), IN `p_Cedula` VARCHAR(50), IN `p_Telefono` VARCHAR(20), IN `p_Correo` VARCHAR(100), IN `p_EstadoPago` VARCHAR(50), IN `p_Comprobante` VARCHAR(255), IN `p_IdCurso` INT, IN `p_IdHorario` INT)   BEGIN
    DECLARE v_cantidadCuotas INT;
    DECLARE v_fechaInicio DATE;
    DECLARE v_cuotasPendientes INT;
    DECLARE v_diasRestantes INT;
...
(286, 'asdasd', 'asdasd', '506', 'asdasd'),
(287, 'qwdqwd', 'qwdq', '506234', '234234234123123'),
(288, 'qwqwe', '1232312', '50631231231', 'werwer');
...
--
-- Estructura de tabla para la tabla `imagenescomprobantes`
--

CREATE TABLE `imagenescomprobantes` (
  `id` int(11) NOT NULL,
  `idImagen` int(11) NOT NULL,
...
(13, 'Carmen Murillo Espinoza', '20482781', '50689873903', 'carmenmurilloespinoza@gmail.com', 'Pendiente', '20250307814830000600298728', 17, 16, NULL, 0, 3, 1, 1, '2025-03-23 16:57:08'),
...
(328, 'asdasd', 'asdasd', '506', 'asdasd', 'Pendiente', '0', 79, 83, NULL, 0, 2, 1, 1, '2025-05-11 08:44:42'),
(329, 'qwdqwd', 'qwdq', '506234', '234234234123123', 'Pendiente', '23423423', 79, 83, NULL, 0, 2, 1, 1, '2025-05-11 08:50:50'),
(330, 'qwqwe', '1232312', '50631231231', 'werwer', 'Pendiente', '12312312', 79, 83, NULL, 0, 2, 1, 1, '2025-05-11 08:52:23');
...
(326, 1, 15000.00, 40, 37, 'Alambrismo y Bisutería - Nivel Principiante', 'CLIENTE', 'SISTEMA', '402730546', 'Valentina gabriela Morales Sánchez ', '50684490254', 'valentinagabriela1406@gmail.com', '', '30860478', '2025-05-12 20:53:27', 0, 0, NULL);
...
(576, 1, 'e47d89fd8064fd4944efecba1038ecc4', '2025-05-12 19:52:29', '2025-05-13 04:52:29');
...
(75, 'Sistema', '506', 'Hola asdasd. Hemos recibido su solicitud de matrícula, pronto le informaremos por este medio cuando ', '2025-05-11 08:44:43'),
(76, 'Sistema', '506234', 'Hola qwdqwd. Hemos recibido su solicitud de matrícula, pronto le informaremos por este medio cuando ', '2025-05-11 08:50:51'),
(77, 'Sistema', '50631231231', 'Hola qwqwe. Hemos recibido su solicitud de matrícula, pronto le informaremos por este medio cuando s', '2025-05-11 08:52:24');
...
--
-- Indices de la tabla `imagenescomprobantes`
--
ALTER TABLE `imagenescomprobantes`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `bitacoria_clientes`
  MODIFY `CONSECUTIVO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=289;
...
--
-- AUTO_INCREMENT de la tabla `imagenescomprobantes`
--
ALTER TABLE `imagenescomprobantes`
...
--
ALTER TABLE `sesiones`
  MODIFY `IDSesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=577;
...
--
ALTER TABLE `whatsapp_log`
  MODIFY `idRegistro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
-- Filtros para la tabla `imagenescomprobantes`
--
ALTER TABLE `imagenescomprobantes`
  ADD CONSTRAINT `fk_curso` FOREIGN KEY (`cursoID`) REFERENCES `cursos` (`ID`);
