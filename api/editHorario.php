...
if (!isset($data->tokenSesion) ||  !isset($data->IdProfesor) || !isset($data->Cupo)) {
...
$sp = "CALL SP_EditarHorario(?, ?, ?, @resultado, @mensaje)";
$stmt_sp = $conn->prepare($sp);
$stmt_sp->bind_param("iii", $IdHorario, $IdProfesor, $Cupo);
$stmt_sp->execute();
