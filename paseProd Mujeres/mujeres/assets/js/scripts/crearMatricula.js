...
async function obtenerHorarios(cursoID) {
    try {
        const response = await fetch('https://cursomujerescr.com/api/listarHorarioCursoUsuario.php', {
            method: 'POST',
            headers: {
...
async function crearMatricula() {
    ...
    try {
        const response = await fetch('https://cursomujerescr.com/api/crearMatriculaUsuario.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function notificarCreacionMatricula(phone, studentName) {
    ...
    try {
        ...
        if (whatsappResponse.ok) {
            ...
            const dbResponse = await fetch('https://cursomujerescr.com/api/RegistrarLogWhatsApp.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
