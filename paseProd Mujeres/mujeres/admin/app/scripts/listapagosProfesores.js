...
async function cargarPagosPendientes() {
    const url = 'https://cursomujerescr.com/api/PagosPendientesProfesores.php'; // API que devuelve los pagos pendientes
...
async function pagarCursoProfesor(cursoID) {
    try {
        ...
        if (confirmResult.isConfirmed) {
            ...
            const response = await fetch('https://cursomujerescr.com/api/pagarCursoIdProfe.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
async function actualizarPagosPorCedula() {
    try {
        ...
        if (confirmResult.isConfirmed) {
            ...
            // Hacer la solicitud POST al API
            const response = await fetch('https://cursomujerescr.com/api/pagosProfesoresCedula.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
